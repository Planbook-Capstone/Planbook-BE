            ...
            content = @Content(
                    ...
                    examples = {
                            @ExampleObject(
                                    ...
                                    value = "{\"lessonPlanId\": 101, \"parentId\": null, \"title\": \"Mục tiêu bài học\", \"content\": \"Học sinh hiểu được khái niệm cơ bản\", \"type\": \"SECTION\", \"orderIndex\": 1}"
                            ),
                            @ExampleObject(
                                    name = "Tạo Subsection",
                                    summary = "Tạo một subsection con",
                                    value = "{\"lessonPlanId\": 101, \"parentId\": 1, \"title\": \"Kiến thức cần đạt\", \"content\": \"Nắm vững lý thuyết\", \"type\": \"SUBSECTION\", \"orderIndex\": 1}"
                            ),
                            @ExampleObject(
                                    name = "Tạo List Item",
                                    summary = "Tạo một mục danh sách",
                                    value = "{\"lessonPlanId\": 101, \"parentId\": 2, \"title\": \"Điểm 1\", \"content\": \"Hiểu khái niệm A\", \"type\": \"LIST_ITEM\", \"orderIndex\": 1}"
                            )
                    }
            )
    )
            ...
            content = @Content(
                    ...
                    examples = {
                            @ExampleObject(
                                    ...
                                    value = "{\"title\": \"Mục tiêu bài học đã cập nhật\", \"content\": \"Học sinh hiểu được khái niệm nâng cao\"}"
                            ),
                            @ExampleObject(
