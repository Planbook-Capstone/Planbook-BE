...
public interface ExamResultDetailMapper {
    ...
    @Mapping(target = "questionNumber", source = "detailData.questionNumber")
    @Mapping(target = "partName", source = "detailData.partName")
    @Mapping(target = "statementKey", source = "detailData.statementKey")
    @Mapping(target = "question", source = "detailData.question")
